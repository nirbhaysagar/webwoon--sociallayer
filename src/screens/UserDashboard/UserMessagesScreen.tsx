...
import { View, Text, StyleSheet, FlatList, Image, TextInput, Alert, Animated, TouchableOpacity } from 'react-native';
...
const ConversationCard = ({ item, onPress }) => {
    ...
    return (
        <AnimatedTouchableOpacity
            style={[styles.conversationCard, { transform: [{ scale: scaleValue }] }]}
            onPress={onPress}
    ...
    return (
      <View style={styles.container}>
        <View style={styles.chatHeader}>
          <Button onPress={() => setSelectedConversation(null)} style={styles.backBtn}>
    ...
    <View style={styles.container}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          keyExtractor={item => item.id}
          renderItem={({ item }) => <ConversationCard item={item} onPress={() => handleConversationSelect(item)} />}
